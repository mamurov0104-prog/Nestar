import { Args, Mutation, Resolver, Query } from '@nestjs/graphql'; // Query shu yerdan bo'lishi shart
import { PropertyService } from './property.service';
import { Properties, Property } from '../../libs/dto/property/property';
import { AgentPropertiesInquiry, AllPropertiesInquiry, PropertiesInquiry, PropertyInput } from '../../libs/dto/property/property.input';
import { MemberType } from '../../libs/enums/member.enum';
import { Roles } from '../auth/decorators/roles.decorator';
import { UseGuards } from '@nestjs/common'; // Faqat UseGuards qoladi
...
export class PropertyResolver {
    ...
    public async createProperty(
        ...
        // createProperty'ga memberId ni ham berib yuborish mantiqan to'g'ri
