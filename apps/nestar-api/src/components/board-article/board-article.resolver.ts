...
// MUHIM: isolatedModules xatosini yo'qotish uchun 'import type' ishlatamiz
...
export class BoardArticleResolver {
    ...
    @UseGuards(WithoutGuard)
    @Query((returns) => BoardArticles) // Mutation edi, Query qilindi mantiqan to'g'ri bo'lishi uchun
