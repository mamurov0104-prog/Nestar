...
export class BoardArticleResolver {
	...
	createBoardArticle(@Args('input') input: BoardArticleInput, @AuthMember('_id') memberId: ObjectId): Promise<BoardArticle> {
	...
	public async getBoardArticle(
	  ...
	  return await this.boardArticleService.getBoardArticle(memberId, targetId);
	}
	...
	@Query((returns) => BoardArticles)
	public async getAllBoardArticlesByAdmin(@Args('input') input: AllBoardArticlesInquiry, @AuthMember('_id') memberId: ObjectId): Promise<BoardArticles> {
	...
	public async removeBoardArticleByAdmin(@Args('articleId') input: string): Promise<BoardArticle> {
		console.log('Mutation: deleteBoardArticleByAdmin');
